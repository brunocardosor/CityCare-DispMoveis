...
public abstract class GenericDAO<T> extends SQLiteOpenHelper{
    ...
    private String tabela[] = {"endereco","usuario", "denuncia", "categoria"};
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS" + tabela[1] + "(" +
                "id_"+tabela[1] +" LONG primary key auto_increment," +
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS" + tabela[2] + "(" +
                "id_"+tabela[2]+" LONG primary key auto_increment,"+
                "descricao_categoria VARCHAR(45) not null);");

        db.execSQL("CREATE TABLE IF NOT EXISTS" + tabela[3] +"(" +
                "id_" + tabela[3] + " LONG primary key auto_increment,"+
                "denuncia_id_usuario LONG not null," +
                "denuncia_id_categoria LONG not null," +
                "descricao_denuncia VARCHAR(400) not null,"+
